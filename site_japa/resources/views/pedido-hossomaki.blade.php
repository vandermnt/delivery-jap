      ...
      <div class="col-sm-9">
        <div class="row">
          ...
          <form role="form" method="post" action=" {{ action('CompraController@addProdutoCarrinho') }}">
            ...
            <div class="card-deck" style="width: 21rem; height: 35rem; margin-bottom: 10px">
  <div class="card">
    ...
    <div class="card-body">
                  ...
                  <p style="font-size:20px" class="card-text">Unidade:  <b style="color: green"> R$ {{ $valor_formatado }} </b></p>
