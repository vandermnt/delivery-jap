      ...
      <div class="col-sm-9">
        <div class="row">
          ...
          <form role="form" method="post" action=" {{ action('CompraController@addProdutoCarrinho') }}">
            ...
            <div class="card-deck" style="width: 21rem; height: 33rem; margin-bottom: 10px">
  <div class="card">
                <img class="card-img-top" src="{{ url("/img/$e->img_produto") }}" alt="Card image cap">
    <div class="card-body">
      
                  <p style="font-size: 18px" class="card-title">{{ $e->sabor }} </p>
                  <?php $valor_formatado = number_format($e->preco, 2, ',', '.'); ?>
                  <p style="font-size:16px" class="card-text">Unidade:  <b style="color: green"> R$ {{ $valor_formatado }} </b></p>
    </div>
