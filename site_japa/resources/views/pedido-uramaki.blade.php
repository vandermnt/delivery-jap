      ...
      <div class="col-sm-9">
        <div class="row">
          ...
          <form role="form" method="post" action=" {{ action('CompraController@addProdutoCarrinho') }}">
            ...
            <div class="card-deck" style="width: 21rem; height: 38rem; margin-bottom: 10px">
  <div class="card">
    ...
    <div class="card-body">
                  ...
                  <p style="font-size:21px" class="card-text">Unidade:  <b style="color: green"> R$ {{ $valor_formatado }} </b></p>
        ...
        <div class="card">
          <h5 id="fonteMeuPedido" class="card-header" style="background:red; font-size: 2vw"><i class="fa fa-file-text-o" aria-hidden="true"></i>
            ...
            <div class="card-body">
              ...
              <div class="row" style="font-family: 'Signika', sans-serif; font-size:1.2vw;">
                <div class="col-sm-4">
                  <a href="{{ action('CompraController@excluirUramaki', ['id' => $c->id])}}"> <i style="margin-left:15px; font-size:35px; color: black" class="fa fa-trash-o" aria-hidden="true"></i> </a>
                </div>
                <div class="col-8">
